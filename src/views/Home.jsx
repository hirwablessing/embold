...
const Home = () => {
      ...
      <Sidebar/>
        <div className="mx-auto py-6 sm:px-6 lg:px-8 px-5 flex flex-col w-full">
          ...
          <div class="relative text-gray-600 focus-within:text-gray-400 mt-4">
            ...
            <input type="search" name="q" className="py-2 h-8 text-sm text-black border-2 border-black-50 rounded-full outline-none pl-10" placeholder="Search..." autocomplete="off"/>
    </div>
  ...
  <div className="flex flex-row justify-between">
    <div className="flex flex-col gap-4 justify-between">
      ...
      <label class="inline-flex items-center mt-3">
          <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" checked/><span class="ml-2 text-gray-700">Send Notifications</span>
      </label>
      ...
      <div className="w-32 h-12 mt-10 ml-28">
        <label class="w-64 flex flex-col h-32 justify-center items-center px-4 py-6 bg-white text-blue rounded-lg tracking-wide uppercase border border-blue cursor-pointer">
                ...
                <input type='file' class="hidden" accept="image/jpg, image/png"/>
            </label>
          <Button title="select image" bgColor="bg-gray-100" color="white"/>
      </div>
    </div>
  </form>
  ...
  <hr className="bg-gray-100 w-full mt-10"/>
        ...
        <div className="flex flex-row gap-4">
          <Button title="add user" bgColor="bg-green-300" color="text-white"/>
